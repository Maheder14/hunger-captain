...
Check out [FRONTEND LIVE DEMO](https://sd-frontend.maheder.repl.co/) here!!

Check out [API LIVE DEMO](https://sd-backend.maheder.repl.co) here!!
...
1. Git Clone https://github.com/Maheder14/hunger-captain
